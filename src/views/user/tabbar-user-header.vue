...
export default {
  ...
  methods: {
    getUserInfo() {
      ...
      this.avatar = infoData.avatar=="undefined"||infoData.avatar==null? avatar_default:infoData.avatar;
      this.nickName = infoData.nickName=="undefined"||infoData.nickName==null?  '昵称':infoData.nickName;
    },
    toSetting() {
