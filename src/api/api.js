...
const LoginInfo='/login/info'; //查询登录状态
...
const LoginQRCodePic='/login/getQRCode'; //获取微信公众号登录的二维码
export function loginQRCodePic() {
  return request({
    url: LoginQRCodePic,
    method: 'get'
  })
...
}const AuthSetMobile='/auth/set/mobile'; //设置手机号
export function authSetMobile(data) {
  return request({
    url: AuthSetMobile,
    method: 'post',
    data
...
export const ChangJingCaseList='/case/list'; //获得场景示例列表
export function changJingCaseList(query) {
  return request({
    url: ChangJingCaseList,
    method: 'get',
    params: query
  })
}
...
const ChatStreamImg='/chat/stream/img'; //生成图片
export function chatStreamImg(data) {
  return request({
    url: ChatStreamImg,
    method: 'post',
    data
...
const DetailStreamChat='/detail/ai/content'; //获取对话内容
export function detailStreamChat(data) {
  return request({
    url: DetailStreamChat,
    method: 'post',
    data
  })
}
